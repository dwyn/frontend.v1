...
[OpenInCode](https://github.com/sozercan/OpenInCode)<br>
...
- [Operator Mono](https://github.com/dwyn/operator-mono-lig)(with Ligatures) <br>
  Also see [this repo](https://github.com/kiliman/operator-mono-lig) for generating your own Operator Mono w/ Ligatures.
...
- I absolutely love [Eloquent Javascript](https://eloquentjavascript.net/).

- ...and, believe it or not, the [React Documentation](https://reactjs.org/docs/getting-started.html) is very well written!
  <br>
  <br>
...
- [AT&T Archives: The UNIX Operating System](https://youtu.be/tc4ROCJYbm0) <br>
  Fun lil deep-dive on the history of of UNIX operating systems.

- [Beginner's Guide to the Bash Terminal](https://youtu.be/oxuRxtrO2Ag) <br>
...
- [Go Rails](https://www.youtube.com/channel/UCIQmhQxCvLHRr3Beku77tww/videos)<br>
...
For Javascript I absolutely love FunFunFunction, The Coding Train, and Pluralsight.

- [FunFunFunction](https://www.youtube.com/channel/UCO1cgjhGzsSYb1rsB4bFe4Q/videos)<br>
  Just an awesome engineer with 10+ years experience, breaking down important JavaScript concepts in easy-to-absorb manner. Definitely check him out!

- [The Coding Train](https://www.youtube.com/user/shiffman/videos)<br>
